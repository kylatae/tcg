...
async function addStarterDeck(starterDeck, user){
  try{
    ...
    var newCards = [...starterDeck.cardArray]
    for(i=0; i<starterDeck.cardArray.length; i++){
    var individualCard = ({cardId: `${starterDeck.cardArray[i]}`, cardType: `${starterDeck.cardType[i]}`, cardQty: 1});
